    ...
    return Obx(()=>CustomLoader(
      ...
      child: Stack(
        children: [
          ...
          Positioned.fill( // Makes the image fill the entire available space
            child: Obx(() => Image.asset( // Use Image.asset directly
                ...
                children: [
                  ...
                  InkWell(
                    onTap: () async {
                      ...
                      controller.dOBTFController.text =
                          AppGlobals.formatDate(date);
                    },
                  ...
                  Align(
                      ...
                      child: CustomText('Gender*',style: AppTextTheme.bodyMedium)),
                  5.verticalSpace,
                  FormField<String>(
                    validator: (value) {
                      final selectedValue =
                          controller.genderTFController.text;
                      if ((selectedValue.isEmpty || selectedValue == 'Choose One')) {
