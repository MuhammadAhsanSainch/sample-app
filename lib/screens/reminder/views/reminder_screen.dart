...
import 'package:path_to_water/screens/reminder/views/reminder_listing_screen.dart';
...
class ReminderScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder(
      ...
      builder: (_) {
        return Visibility(
          // visible: controller.reminderList.isNotEmpty,
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  CustomImageView(imagePath: AppConstants.reminderCalendarIcon, height: 100.h),
                  24.verticalSpace,
                  CustomText('No Reminder Yet', fontSize: 20.sp, textAlign: TextAlign.center),
                  24.verticalSpace,
                  CustomText(
