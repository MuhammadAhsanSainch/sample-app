...
//                   HomeController.find.currentTabIndex.value = 0;
//                 } else {
//                   Scaffold.of(context).closeDrawer();
//                   HomeController.find.selectedIndex.value = 2;
//                   HomeController.find.currentTabIndex.value = 0;
//                 }
//                 HomeController.find.tabletScreenHeading.value = "Dashboard";
//               },
//             ),
...
//                   if (Get.context?.isTablet ?? false) {
//                     HomeController.find.currentTabIndex.value = 1;
//                   } else {
//                     Scaffold.of(context).closeDrawer();
//                     HomeController.find.selectedIndex.value = 3;
//                     HomeController.find.currentTabIndex.value = 1;
//                   }
//                   HomeController.find.tabletScreenHeading.value =
//                       "User Management";
//                 },
//               ),
...
//                 onTap: () {
//                   if (Get.context?.isTablet ?? false) {
//                     HomeController.find.currentTabIndex.value = 2;
//                   } else {
//                     Scaffold.of(context).closeDrawer();
...
//                 onTap: () {
//                   if (Get.context?.isTablet ?? false) {
//                     HomeController.find.currentTabIndex.value = 3;
//                   } else {
//                     Scaffold.of(context).closeDrawer();
//                     HomeController.find.selectedIndex.value = 1;
//                     HomeController.find.currentTabIndex.value = 3;
//                   }
//                   HomeController.find.tabletScreenHeading.value =
...
//               onTap: () {
//                 if (Get.context?.isTablet ?? false) {
//                   HomeController.find.currentTabIndex.value = 4;
//                 } else {
//                   Scaffold.of(context).closeDrawer();
...
//               onTap: () {
//                 if (Get.context?.isTablet ?? false) {
//                   HomeController.find.currentTabIndex.value = 5;
//                 } else {
//                   Scaffold.of(context).closeDrawer();
...
//                             HomeController.find.currentTabIndex.value == index
//                                 ? AppColors.secondary
//                                 : Colors.white,
//                             BlendMode.srcIn)),
...
//                       title,
//                       style: TextStyle(
//                           color: HomeController.find.currentTabIndex.value ==
//                                   index
//                               ? AppColors.secondary
//                               : Colors.white,
//                           fontSize: 16.0),
